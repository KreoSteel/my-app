                ...
                <div className="flex flex-col items-center absolute top-[42%] left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-gray-200 rounded-md p-10 shadow-double">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 mt-10 items-center">
                        ...
                        <div className="flex flex-col gap-2 w-96">
                            ...
                            <Input type="text" id="fullName" placeholder="Full Name" className="placeholder:text-gray-400" {...register("fullName", { required: "Full name is required" })} />
                        ...
                        <div className="flex flex-col gap-2 w-96">
                            ...
                            <Input type="password" placeholder="Password" className="placeholder:text-gray-400" {...register("password", { required: "Password is required" })} />
